...
public class IocScopeTest {
	...
	public void prototypeTest() {
		...
		for (int i = 0; i < 10; i++) {
			...
			BoardRepositoryI boardRepository_p = context.getBean("boardRepository_p", BoardRepositoryI.class); 
			
			logger.debug("singleton-boardRepository : {}, prototype-boardRepository : {}", boardRepository, boardRepository_p);
		}
